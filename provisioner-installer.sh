...
echo -e "\e[0;32m Upgrade The Base Packages \e[0m"

export DEBIAN_FRONTEND=noninteractive
apt-get update > /dev/null 2>&1
apt-get upgrade -y > /dev/null 2>&1

echo -e "\e[0;32m Add A Few PPAs To Stay Current \e[0m"
...
echo -e "\e[0;32m Upgrade Packages \e[0m"

apt-get update > /dev/null 2>&1
apt-get upgrade -y > /dev/null 2>&1

echo -e "\e[0;32m Install PHP CLI \e[0m"
...
echo -e "\e[0;32m Install Provisioner \e[0m"
